...
from .DenseVNet import AbsolutePositionalEncoder
...
class DenseVNet2D(nn.Module):
    def __init__(self, in_channels: int = 1, classes: int = 1, scaling_version="TINY"):
        super().__init__()

        self.model_name = "DenseVNet2D"
        ...
        elif scaling_version == "DEEPER":
            kernel_size = [5, 3, 3]
            num_downsample_channels = [36, 36, 36]
            num_skip_channels = [12, 24, 24]
            units = [8, 16, 16]
            growth_rate = [4, 8, 16]
        elif scaling_version == "DEEPER_1":
            kernel_size = [5, 3, 3]
            num_downsample_channels = [24, 24, 24]
            num_skip_channels = [24, 48, 48]
            units = [8, 16, 16]
            growth_rate = [4, 8, 16]
        elif scaling_version == "DEEPER_2":
            kernel_size = [5, 3, 3]
            num_downsample_channels = [24, 36, 48]
            num_skip_channels = [12, 24, 36]
            units = [8, 16, 16]
            growth_rate = [4, 8, 16]
        elif scaling_version == "DEEPER_3":
            kernel_size = [5, 3, 3]
            num_downsample_channels = [24, 36, 48]
            num_skip_channels = [12, 24, 36]
            units = [8, 16, 16]
            growth_rate = [6, 12, 24]
        elif scaling_version == "DEEPER_4":
            kernel_size = [5, 3, 3]
            num_downsample_channels = [24, 36, 48]
            num_skip_channels = [24, 36, 48]
            units = [8, 16, 16]
            growth_rate = [4, 8, 16]
